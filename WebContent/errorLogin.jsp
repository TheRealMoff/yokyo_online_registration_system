	...
	<div class="card"> 
        <div class="header"> 
          <div class="image">
            ...
            <div class="content">
               <span class="title">Invalid Log In</span> 
               <p class="message">Oops looks like you missed something.
                <br>
                TOTALY NOT SPORTY
               </p> 
               </div> 
               <div class="actions">
                  <button class="login" type="button" onclick="window.location.href='login.jsp'">Retry</button> 
                    </div> 
                  </div> 
                  </div>
